...
{   
    ...
    */
    ...
    while (jouer)
    {
        ...
        // remplissage emplacementsBombes
        bombes(emplacementsBombes, LARGEUR, LONGUEUR, NOMBRE_BOMBES);
        //Initialisation des tableaux en fonction des emplacements de bombe
        initialisationTableaux(tableauVisible, tableauInvisible, emplacementsBombes, LARGEUR, LONGUEUR, NOMBRE_BOMBES);
